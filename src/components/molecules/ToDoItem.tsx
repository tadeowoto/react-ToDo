...
const ToDoItem = ({ task, completed, onComplete, onDelete }: Props) => {
  ...
  const checkboxStyle = completed ? "w-3 h-3 border-gray-300 disabled:opacity-50 disabled:cursor-not-allowed" : "w-3 h-3 border-[3px] border-t-[#dfdfdf] border-r-[#808080] border-b-[#808080] border-l-[#dfdfdf]"
